...
def read_table(table_name: str, conn: Connection, after_time: str):
    """
    This function:
         gets updated rows from one table in the 
         ToteSys postgreSQL database if those 
         rows were updated after a passed-in time 
         after_time.
    ...
    Args:
         ...
         after_time: a time stamp. On the very 
          ...
          represents date 1/1/1900. On 
          subsequent runs it represents the 
          time of the previous run of this 
          handler.
