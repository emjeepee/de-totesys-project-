...
# 2)
# [
# [20496, 'SALE', 14504, None, datetime.datetime(2025, 6, 4, 8, 58, 10, 6000),
#                       datetime.datetime(2025, 6, 4, 8, 58, 10, 6000)],
# [20497, 'SALE', 14505, None, datetime.datetime(2025, 6, 4, 9, 26, 9, 972000),
#                       datetime.datetime(2025, 6, 4, 9, 26, 9, 972000)],
# [20498, 'SALE', 14506, None,
# datetime.datetime(2025, 6, 4, 9, 29, 10, 166000),
# datetime.datetime(2025, 6, 4, 9, 29, 10, 166000)],
# etc  ]

# 3) List to create:
#   [ { 'transaction_id' :  20496,   'transaction_type' :  'SALE',
#           'sales_order_id': 14504, etc},
#      { 'transaction_id' :  20497,   'transaction_type' :  'SALE',
#           'sales_order_id': 14505, etc},
#       etc
#
#    ]
