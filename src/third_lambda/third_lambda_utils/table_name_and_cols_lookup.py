...
# that table:
    ...
    fact_sales_order_cols =  ["sales_order_id", "created_date", 
    ...
    dim_counterparty_cols = [ 'counterparty_id', 'counterparty_legal_name',  
    ...
    dim_currency_cols = ['currency_id', 'currency_code', 
                    'currency_name']
    
    dim_design_cols = ['design_id', 'design_name', 
                  'file_location', 'file_name' ]
    
    dim_location_cols = ['address_line_1', 'address_line_2', 
                    'district', 'city', 'postal_code', 
                    'country', 'phone' ]
    
    dim_staff_cols = ['Staff_id',
                 'first_name',
                 'last_name',   
                 'department_id',
                 'email_address' 
