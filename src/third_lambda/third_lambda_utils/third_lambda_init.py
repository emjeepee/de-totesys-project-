...
def third_lambda_init(event, conn_to_db, close_db, s3_client):
    ...
    #             },
    #             "object": {
    #                 "key": "design/2025-06-13_13-23.parquet" OR
    #                   fact_sales_order/2025-06-13_13-23.parquet,
    ...
    lookup = {
        ...
        "proc_bucket": event["Records"][0]["s3"]["bucket"][
            "name"
        ],  # name of processed bucket
        "table_name": object_key.split("/")[
            0
        ],  # name of Parquet file in processed bucket
        "conn": conn_to_db(
            os.environ["WAREHOUSE_NAME"]
        ),  # !!!!CHANGED!!!!! pg8000.native Connection object !!!!CHANGED!!!!!
