...
def transform_to_star_schema_fact_table(table_data):
    ...
    for row in table_data:
        ...
        facts_table_row = {
            ...
            "sales_order_id": row.get("sales_order_id"),  # warehouse: int NN
            ...
            "counterparty_id": row.get("counterparty_id"),  # w'house: int NN
            ...
            "agreed_delivery_location_id": row.get(
                "agreed_delivery_location_id"
            ),  # in warehouse is int NN
        }
