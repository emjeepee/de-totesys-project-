from .transform_to_star_schema_fact_table import (
    transform_to_star_schema_fact_table)
...
def func_lookup_table(table_name: str):
    ...
    lookup_table = {
        ...
        # transform_to_dim_location() converts address table
        # to location dim table:
