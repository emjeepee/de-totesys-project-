...
def make_parts_of_insert_statements(data):
    ...
    # list of them:
    columns = list(data[0].keys()) # ["col_name_1", "col_name_2", "col_name_3", etc]
    ...
    for row in data: # {"col_name_1": "val_1", "col_name_2": "val_2", etc}
        ...
        values = [str(row[col]) for col in columns] # ["val_1", "val_2", "val_3", etc]
        values_list.append(values) #[["val_1", "val_2", etc], ["val_1", "val_2", etc], etc]
