...
from src.utils_write_to_ingestion_bucket import write_to_ingestion_bucket, save_updated_table_to_S3, get_most_recent_table_data
...
def test_that_lambda_handler_of_first_lambda_function_integrates_two_functions():
    ...
    with patch("src.lambda_handler.close_db") as mock_close_db, patch("src.lambda_handler.conn_to_db") as mock_conn_to_db, patch("src.lambda_handler.get_data_from_db") as mock_get_data_from_db, patch("src.lambda_handler.write_to_s3") as mock_write_to_s3, patch("src.lambda_handler.read_table") as mock_read_table, patch("src.lambda_handler.convert_data") as mock_convert_data:
        mock_get_data_from_db.return_value = jsonified_mock_dict
        ...
        mock_write_to_s3.assert_called_once_with(jsonified_mock_dict, ANY,  ANY, "11-ingestion-bucket")
