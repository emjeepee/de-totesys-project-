...
def test_get_data_from_db_returns_python_list_each_of_whose_members_is_jsonified_python_list_of_dicts():
    ...
    response = get_data_from_db(tables_1, "1960-01-01 00:00:00", 'xxx', mock_read_table, convert_data)
...
# @pytest.mark.skip 
def test_write_to_s3_saves_a_whole_table_to_the_bucket_when_no_key_in_bucket_equals_table_name(S3_setup):
    # s3 bucket is empty
    ...
    data_list = get_data_from_db(tables_1, "1900-01-01 00:00:00", 'xxx', mock_read_table, convert_data)
...
def test_write_to_s3_saves_a_whole_table_to_the_bucket_when_no_key_in_bucket_equals_table_name(S3_setup):
    ...
    modified_rows = [{"design_id": 1, "name": "abdul", "team":2},
    ...
    # passed its tests):
    save_updated_table_to_S3(json.dumps(whole_table), S3_setup, 'design/111111.json', "11-ingestion-bucket")
