...
resource "aws_lambda_function" "mod_lambda" {
  ...
  environment {
    variables = {
     TF_VAR_AWS_INGEST_BUCKET = var.AWS_INGEST_BUCKET
     TF_VAR_AWS_PROCESS_BUCKET = var.AWS_PROCESS_BUCKET
     TF_VAR_AWS_CODE_BUCKET = var.AWS_CODE_BUCKET
     TF_VAR_AWS_STATE_BUCKET = var.AWS_STATE_BUCKET
     TF_VAR_AWS_ALERT_EMAIL = var.AWS_ALERT_EMAIL
     TF_VAR_AWS_TABLES_LIST = var.AWS_TABLES_LIST
     TF_VAR_TOTE_SYS_DB_USER = var.TOTE_SYS_DB_USER
     TF_VAR_TOTE_SYS_DB_PASSWORD = var.TOTE_SYS_DB_PASSWORD
     TF_VAR_TOTE_SYS_DB_DB = var.TOTE_SYS_DB_DB
     TF_VAR_TOTE_SYS_DB_PORT = var.TOTE_SYS_DB_PORT
     TF_VAR_TOTE_SYS_DB_HOST = var.TOTE_SYS_DB_HOST
     TF_VAR_WAREHOUSE_DB_USER = var.WAREHOUSE_DB_USER
     TF_VAR_WAREHOUSE_DB_PASSWORD = var.WAREHOUSE_DB_PASSWORD
     TF_VAR_WAREHOUSE_DB_DB = var.WAREHOUSE_DB_DB
     TF_VAR_WAREHOUSE_DB_PORT = var.WAREHOUSE_DB_PORT
     TF_VAR_WAREHOUSE_DB_HOST = var.WAREHOUSE_DB_HOST
                }
              }
                                            }
